...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        public ActionResult Update(int id, string PetName, string PetColor, double PetWeight, string PetNotes)
        {
            ...
            string query = "update pets set PetName = '@PetName', Weight='@PeiWeight', color='@PetColor', Notes='@PetNotes' where PetID=@id";
            SqlParameter[] parameters = new SqlParameter[5]; //5 pieces
            ...
            parameters[4] = new SqlParameter("@PetId", id);
